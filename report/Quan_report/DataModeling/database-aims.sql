...
CREATE TABLE "RushDeleveryInfo"(
    "id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,
    "name" VARCHAR(45),
    "province" VARCHAR(45),
    "instructions" VARCHAR(200),
    "address" VARCHAR(100),
    "rushShippingTime" DATETIME NOT NULL
);
...
CREATE TABLE "Order"(
    ...
    CONSTRAINT "fk_Order_DeleveryInfo1" FOREIGN KEY("deleveryInfoId") REFERENCES "DeleveryInfo"("id")
);

CREATE TABLE "RushOrder"(
    "id" INTEGER NOT NULL,
    "rushDeleveryInfoId" INTEGER NOT NULL,
    PRIMARY KEY("id"),
    CONSTRAINT "fk_RushOrder_Order1" FOREIGN KEY("id") REFERENCES "Order"("id"),
    CONSTRAINT "fk_RushOrder_RushDeleveryInfo1" FOREIGN KEY("rushDeleveryInfoId") REFERENCES "RushDeleveryInfo"("id")
);
